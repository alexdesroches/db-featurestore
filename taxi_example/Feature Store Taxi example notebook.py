...
mlflow.lightgbm.log_model(
        ...
        registered_model_name="taxi_example_fare_packaged_aci")
...
# MAGIC 1. Set up a Databricks Model Serving Endpoint
# MAGIC 1. Set up a ACI Webservice
# MAGIC 1. Set up model serving AKS
...
import mlflow.azureml
latest_model_version = get_latest_model_version("taxi_example_fare_packaged_aks")
model_uri = f"models:/taxi_example_fare_packaged_aks/{latest_model_version}"
model_image, azure_model = mlflow.azureml.build_image(model_uri=model_uri, 
                                                      workspace=azure_workspace,
                                                      model_name="taxiexamplefareaks01",
                                                      image_name="taxiexamplefareaks01",
                                                      description="taxi_example_fare_packaged_nofeaturemeta",
                                                      synchronous=False)
...
prod_webservice_name = "taxi-aks-01"
prod_webservice_deployment_config = AksWebservice.deploy_configuration()

# Deploy from image
prod_webservice = Webservice.deploy_from_image(workspace = azure_workspace, 
